...
(function () {
  ...
  document.addEventListener('click',event=>{
    ...
    let b
    if((b=target.closest('[data-eh-export]'))){document.dispatchEvent(new CustomEvent('tasker-hours-export',{detail:{state:JSON.parse(JSON.stringify(state)),action:b.dataset.ehExport,format:el('eh-export-format').value}}));return}
