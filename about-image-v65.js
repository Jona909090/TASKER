// TASKER v65: odobrena autorska slika prikazana direktno u aplikaciji.
(() => {
  ...
  style.textContent = `
    ...
    .tasker-about-image{display:block;width:100%;height:auto;min-height:420px;object-fit:contain;background:#03111f;filter:saturate(1.03) contrast(1.025) brightness(.98);transform:translateZ(0)}
    ...
    @media(max-width:900px){.tasker-about-image-page{padding:10px 0 28px}.tasker-about-image-shell{border-radius:15px}.tasker-about-image{min-height:0}.tasker-about-image-shell:after{animation-duration:11s}}
