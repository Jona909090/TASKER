(function(){
  ...
  function refresh(){
    ...
    el('ms-halls').innerHTML=[hall].map(h=>{
      ...
      return `<div class="ms-map-scroll"><section class="ms-hall" aria-label="${esc(h.name)}"><div class="ms-gate"><span></span><b>ULAZ ↑</b><span></span></div><div class="ms-floor"><div class="ms-row">${row('left')}</div><div class="ms-safe-zone" aria-label="Radna zona"></div><div class="ms-aisle"><div class="ms-forklift-route" aria-hidden="true"><svg class="ms-forklift" viewBox="0 0 60 100" focusable="false"><ellipse cx="31" cy="60" rx="25" ry="32" fill="#000" opacity=".28"/><path d="M17 29V3h5v26m16 0V3h5v26" fill="#bbc5cb" stroke="#394550" stroke-width="2"/><rect x="13" y="5" width="34" height="20" rx="2" fill="#b98440" stroke="#543b21" stroke-width="2"/><path d="M15 10h30M15 19h30M22 6v18M38 6v18" stroke="#e7bc72" stroke-width="2"/><g fill="#111c25" stroke="#67717a"><rect x="5" y="34" width="10" height="21" rx="3"/><rect x="45" y="34" width="10" height="21" rx="3"/><rect x="7" y="72" width="9" height="17" rx="3"/><rect x="44" y="72" width="9" height="17" rx="3"/></g><rect x="14" y="30" width="32" height="59" rx="8" fill="#f2b529" stroke="#805714" stroke-width="2"/><path d="M18 76h24v9H18z" fill="#d68b14"/><rect x="15" y="30" width="30" height="7" rx="1" fill="#596771" stroke="#141e26" stroke-width="2"/><rect x="18" y="43" width="24" height="29" rx="3" fill="#183b4d" stroke="#0c1720" stroke-width="3"/><path d="M20 45l19 23M40 45L21 68" stroke="#8baab6" stroke-width="2"/><path d="M19 43v29M41 43v29" stroke="#c1cbd0" stroke-width="3"/><rect x="17" y="37" width="6" height="4" fill="#fff4b0"/><rect x="37" y="37" width="6" height="4" fill="#fff4b0"/><circle class="ms-forklift-beacon" cx="30" cy="77" r="3" fill="#fff098"/></svg></div><span>CENTRALNI PROLAZ</span><i>↑</i><b>${esc(h.name)}</b><i>↓</i></div><div class="ms-safe-zone" aria-label="Radna zona"></div><div class="ms-row">${row('right')}</div></div><div class="ms-gate"><span></span><b>VRATA / IZLAZ ↓</b><span></span></div></section></div>`
    }).join('')
