(function(root){
  ...
  const phaseAliases={
    ...
    'Vuna u pod 200 mm':['Vuna u podu'],
    'Postavljanje plywooda':['Plywood'],
    'Postavljanje Cetris ploča':['Cetris ploče'],
    'Postavljanje vune u strop 80/100 mm':['Vuna u stropu'],
    'Postavljanje stropnih panela':['Stropni paneli'],
    'Postavljanje panel holdera':['Panel holderi'],
    'Postavljanje zidnih panela':['Zidni paneli'],
    'Oblaganje okvira vrata Promatom':['Promat oko vrata','Promat'],
    'Silikoniranje modula':['Silikoniranje']
  }
