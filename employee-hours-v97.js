...
(function () {
  ...
  function open () {
    ...
    content.innerHTML=`<section id="${pageId}">
      ...
      <section class="eh-panel"><div class="eh-month-head"><h2>Prisutnost zaposlenih</h2><button class="eh-btn" id="eh-add">+ DODAJ ZAPOSLENOG</button></div><div class="eh-tools"><button class="eh-btn primary" data-eh-all="present">OZNAČI SVE PRISUTNE</button><button class="eh-btn" data-eh-all="absent">OZNAČI SVE ODSUTNE</button></div><p id="eh-unmarked"></p><div id="eh-people"></div><details><summary>Zaposleni s datumom prestanka rada</summary><div id="eh-former"></div></details></section>
